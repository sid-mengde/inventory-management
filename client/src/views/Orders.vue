  ...
  <div class="orders">
    ...
    <div v-else>
      ...
      <div class="card">
        ...
        <div v-if="restockOrders.length === 0" class="no-restock-orders">
          ...
          <table class="orders-table restock-table">
            ...
            <tbody>
              <tr v-for="order in restockOrders" :key="order.id">
                ...
                <td class="col-lead-time">{{ t('orders.leadTimeDays', { count: order.lead_time_days }) }}</td>
...
export default {
  ...
  setup() {
    ...
    // Derived from the same orders ref already fetched above - no extra API call
